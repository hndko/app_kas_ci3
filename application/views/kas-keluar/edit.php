                        ...
                        <form action="<?= base_url() ?>kas-keluar/edit/<?= $res->kas_id ?>" method="post">
                            ...
                            <div class="form-row-modern">
                                ...
                                <textarea name="keterangan"
                                    ...
                                    class="form-control"
                                    rows="4"
                                    placeholder="Tuliskan keterangan pengeluaran..."><?= $res->keterangan ?></textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="fw-bold text-danger">Rp<?= number_format($res->pengeluaran, 0, ',', '.') ?></span>
                            </div>
                        </div>
                    </div>
                </div>
