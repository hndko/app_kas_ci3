  ...
  <section class="section">
    <div class="card card-modern">
      <div class="card-header-modern">
        ...
        <a href="<?= base_url() ?>kas-keluar/create" class="btn btn-modern-primary btn-sm">
            ...
            <div class="border rounded-3 p-3 bg-light">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <span class="rounded-circle d-inline-flex align-items-center justify-content-center bg-danger bg-opacity-10"
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <h5 class="mb-0 text-danger fw-bold">Rp<?= number_format($sumData->pengeluaran, 0, ",", ".") ?></h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="border rounded-3 p-3 bg-light">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <h5 class="mb-0 text-info fw-bold">Rp<?= count($result) > 0 ? number_format($sumData->pengeluaran / count($result), 0, ",", ".") : 0 ?></h5>
                </div>
              </div>
            </div>
          </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <a href="<?= base_url() ?>kas-keluar/edit/<?= $res->kas_id ?>"
                      ...
                      <button type="button"
                        ...
                        title="Hapus"
                        onclick="if (confirm('Apakah Anda yakin ingin menghapus data ini?')) location.href='<?= base_url() ?>kas-keluar/delete/<?= $res->kas_id ?>'">
